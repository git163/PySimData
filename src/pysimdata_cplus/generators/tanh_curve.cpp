...
TanhCurve::TanhCurve(double x_min, double x_max, int num_points,
...
TanhCurve::TanhCurve(const json& params) {
...
json TanhCurve::to_config() const {
    return {
        {"type", "TanhCurve"},
        {"format", "csv"},
        {"params", params_}
